...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110 group"
