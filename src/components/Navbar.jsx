    ...
    <>
      ...
      {/* <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2.5 px-4">
        <div className="max-w-7xl mx-auto flex items-start justify-between gap-4 text-xs sm:text-sm">
          ...
          <a 
            href="https://wa.me/9779861544600?text=Hi!%20I%20need%20help%20with%20my%20assignment."
            target="_blank"
      ...
      {/* Main Navbar */}
      <nav className="fixed top-0 sm:top-0 left-0 right-0 z-50 border-b border-zinc-800/50 bg-[#09090b]/90 backdrop-blur-md">
